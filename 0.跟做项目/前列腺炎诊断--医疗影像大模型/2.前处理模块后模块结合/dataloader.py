...
def create_train_dataset(args: argparse.Namespace) -> torch.utils.data.Dataset:
    args.train_data_root = '/root/prostate-check-zjz/Medical-SAM2-zjz/data/USVideo_final/train'
...
def create_val_dataset(args: argparse.Namespace) -> torch.utils.data.Dataset:
    args.val_data_root = '/root/prostate-check-zjz/Medical-SAM2-zjz/data/USVideo_final/val'
    if args.dummy_dataset:
        return DummyDataset(
