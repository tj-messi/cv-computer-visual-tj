...
def load_data(data_root,dataset_use,status,SR_times,gene_num,all_gene,gene_order=None,gene_name_order=None
    ...
    elif 'Visium_mouse_brain_matched' in dataset_use:
    ...
    elif 'Xenium5k_ovaryovariancancer' in dataset_use:
        dataset= Xenium5kovaryovariancancer(data_root,dataset_use,SR_times,status,gene_num,all_gene,gene_order,gene_name_order)
    return dataset
...
class Xenium5k7(Dataset):
    def __init__(self, data_root, dataset_use,SR_times, status, gene_num, all_gene, gene_order,gene_name_order):
        ...
        for sample_id, patch_id in self.selected_patches:
            ...
            wsi_320_path =  f"{data_root}{dataset_use}/WSI/extract/20240917mousebrain/{patch_id}/320_to16.npy"
            #print(wsi_320_path)
        ...
        metadata_prompt = ("Provide spatial transcriptomics data from the Visium platform for mouse species, with a healthy condition, and brain tissue type.")
        with torch.no_grad():
