...
def get_args():
    ...
    parser.add_argument(
        ...
        choices=[
            ...
            'HMDB51', 'Diving48', 'Kinetics-710', 'MIT', 'GBC_Net','CT_Data'
        ],
        type=str,
        help='dataset')
    parser.add_argument(
    ...
    parser.add_argument('--masking', default=False, action='store_true')
    ...
    parser.add_argument(
        '--decoder_mask_ratio', default= 0.0, type=float)
    
    parser.add_argument(
    '--approach', default= "video_classification", type=str)

    parser.add_argument(
        '--sampling_scheme', default="scheme2", type=str
    )

    parser.add_argument(
        '--pred_column', default="vit_pred", type=str
    )
...
def main(args, ds_init):
    ...
    model = create_model(
        ...
        pretrained=True,
        num_classes=args.nb_classes,
        all_frames=args.num_frames * args.num_segment,
            ...
            if k in checkpoint_model and checkpoint_model[
                ...
                if checkpoint_model[k].shape[
                    ...
                    if args.data_set == 'Kinetics-400':
                        label_map_path = 'misc/label_2.json'
    ...
    utils.auto_load_model(
        ...
        model_ema=model_ema)
    if args.validation:
        test_stats = validation_one_epoch(data_loader_val, model, device, args , model_type="vit")
        print(
    ...
    if args.eval:
        ...
        test_stats = final_test_2(data_loader_test, model, device, preds_file, args, model_type="vit")
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if data_loader_val is not None:
            ...
            if log_writer is not None:
                ...
                log_writer.update(
                    val_acc5=test_stats['acc2'], head="perf", step=epoch)
                log_writer.update(
