...
double gps_offset_y = 5.45;                  // GPS的y轴方向偏�? 
...
// 传送带
motor convey_beltMotorA = motor(PORT9, ratio6_1, false);
motor convey_beltMotorB = motor(PORT13, ratio6_1, true);
motor_group convey_belt = motor_group(convey_beltMotorA, convey_beltMotorB);

// 吸球
motor rollerMotorA = motor(PORT2, ratio18_1, false);
motor rollerMotorB = motor(PORT5, ratio18_1, true);
...
// imu�?性传感器
inertial imu = inertial(PORT7);  // �?二个参数要写right

// 气动�?
pwm_out gas_hold = pwm_out(Brain.ThreeWirePort.H);
