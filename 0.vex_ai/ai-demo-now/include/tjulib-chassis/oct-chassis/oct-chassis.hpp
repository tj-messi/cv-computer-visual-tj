...
namespace tjulib
{
    ...
    public:
        Oct_SmartChassis(std::vector<std::vector<vex::motor*>*> &_chassisMotors, pidControl *_motorpidControl, Position*_position, const T _r_motor,
         pidControl *curpid, pidControl *fwdpid, pidControl *turnpid,T car_width, PurePursuit *_ppcontrol, HighStakeMap *map, RRT *rrt)
            : 
            ...
            Oct_Action(_chassisMotors, _motorpidControl, _position,  _r_motor, fwdpid, turnpid, _ppcontrol, map, rrt)
        {};
    };
};